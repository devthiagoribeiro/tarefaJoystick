...
//Função que desenha uma borda simples no display
void border0(uint8_t *ssd){
    ssd1306_draw_line(ssd, 1, 1, 127, 1, true);
    ssd1306_draw_line(ssd, 127, 1, 127, 63, true);
    ssd1306_draw_line(ssd, 127, 63, 1, 63, true);
    ssd1306_draw_line(ssd, 1, 63, 1, 1, true);
}

//Função que desenha uma borda dupla no display
void border1(uint8_t *ssd){
    ssd1306_draw_line(ssd, 1, 1, 127, 1, true);
    ssd1306_draw_line(ssd, 127, 1, 127, 63, true);
    ssd1306_draw_line(ssd, 127, 63, 1, 63, true);
    ssd1306_draw_line(ssd, 1, 63, 1, 1, true);

    ssd1306_draw_line(ssd, 4, 4, 125, 4, true);
    ssd1306_draw_line(ssd, 124, 4, 124, 60, true);
    ssd1306_draw_line(ssd, 124, 60, 4, 60, true);
    ssd1306_draw_line(ssd, 4, 60, 4, 4, true);
}

// Borda com cantos diagonais
void border2(uint8_t *ssd) {
    ssd1306_draw_line(ssd, 1, 5, 1, 63, true);   // Lateral esquerda
    ssd1306_draw_line(ssd, 5, 1, 127, 1, true);  // Superior
    ssd1306_draw_line(ssd, 127, 5, 127, 63, true); // Lateral direita
    ssd1306_draw_line(ssd, 1, 63, 127, 63, true); // Inferior

    // Cantos diagonais
    ssd1306_draw_line(ssd, 1, 1, 5, 5, true);
    ssd1306_draw_line(ssd, 127, 1, 123, 5, true);
    ssd1306_draw_line(ssd, 1, 63, 5, 59, true);
    ssd1306_draw_line(ssd, 127, 63, 123, 59, true);
}
